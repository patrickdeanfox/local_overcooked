...
Twenty-four scripts, `00-smoke` to `23-throw-dash-gap`, one per shipped feature, each with a header comment saying what it proves. Two libraries are fetched and evaluated by scripts:
