...
export const PALETTE = {
  ...
  fishBelly: '#e9f0f2',
  fishFlesh: '#f1a07f',
  fishFleshLight: '#fbd6c3',
  prawn: '#f2896b',
  prawnDark: '#c4573a',
  prawnLight: '#fcd2c1',
  // Fish and chips (OC1 world 3).
  potato: '#c9a066',
  potatoDark: '#8f6a3a',
  potatoFlesh: '#f3e2b0',
  fried: '#e0a53a',
  ...
  cucumber: '#3f8f3a',
  cucumberDark: '#27602a',
  cucumberFlesh: '#cfe9a8',
  rice: '#f4f1e8',
  riceShade: '#d9d3c2',
  nori: '#23382a',
  noriLight: '#3c5a43',
  // Pasta, burritos, cheese and chicken (Overcooked 2 worlds 1, 2 and 5).
  tortilla: '#e8cf93',
  tortillaSpot: '#c9a45e',
  chicken: '#f1b9a6',
  chickenDark: '#c98a74',
  ...
  pasta: '#f2dd8a',
  pastaDark: '#d4b85a',
  // Pizza (Overcooked 1 world 4, Overcooked 2 world 3).
  dough: '#f1dfb4',
  doughDark: '#d4bb86',
  crust: '#d99a4e',
  pepperoni: '#b8352a',
  ...
  dumpling: '#f3ead6',
  bamboo: '#c9a060',
  // Pancakes and cakes (Overcooked 2 worlds 5 and 6).
  egg: '#f7efe0',
  eggShade: '#d9cdb4',
  yolk: '#f5b82e',
  honey: '#f0a623',
