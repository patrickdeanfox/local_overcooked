...
Twenty-nine scripts, `00-smoke` to `28-look`, one per shipped feature, each with a header comment saying what it proves. Two libraries are fetched and evaluated by scripts:
