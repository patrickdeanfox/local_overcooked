...
Twenty-five scripts, `00-smoke` to `24-level-3-2`, one per shipped feature, each with a header comment saying what it proves. Two libraries are fetched and evaluated by scripts:
